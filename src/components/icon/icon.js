...
export const collectedIcon = () => {
  return (
    <svg viewBox="-7 -5 40 22" fill="green">
      <g>
        <path d="M 17 3 z M 6.5 4 c -0.5 0 -0.5 0.22 -0.5 0 v 0 l 6 0 l 6 0 V 11 h 2 v 11.94 l -8 -5.71 l -8 5.71 V 4.5 C 4 3.12 5.119 2 6.5 2 h 13.5 v 9 H 6 z"></path>
      </g>
    </svg>
  );
};
